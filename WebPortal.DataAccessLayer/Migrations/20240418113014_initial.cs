        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaximumSize = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserProgramDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserProgramDetails_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserProgramDetails_ProgramDetails_ProgramDetailId",
                        column: x => x.ProgramDetailId,
                        principalTable: "ProgramDetails",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProgramDetails_ProgramDetailId",
                table: "UserProgramDetails",
                column: "ProgramDetailId");

            migrationBuilder.CreateIndex(
                name: "IX_UserProgramDetails_UserId",
                table: "UserProgramDetails",
                column: "UserId");
        }
